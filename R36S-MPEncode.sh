#!/bin/zsh
# ============================================================
#  r36s-encode.sh — R36S Media Re-Encoder for macOS
#  Re-encodes MP3 or MP4 to R36S-optimal settings, then
#  pushes the result to your SD card — just like cpush.
#
#  R36S targets  (RK3326 · 640×480 4:3 IPS · Mali-G31):
...
typeset -g LOG_FILE="/tmp/r36s_encode_$(date +%Y%m%d_%H%M%S).log"
...
select_dest() {
    ...
    # Rebuild OUTPUT_FILE with chosen dest dir, keeping _r36s filename
